                                ...
                                <Row className="g-3">
                                    <Col md={4} className="d-flex">
                                        <Card className="w-100">
                                            <Card.Body>
                                                <Card.Text>
                                                    Solution surmesure pour l’optimisation de la gestion et du tri
                                                    de vos biens et déchets.
                                                </Card.Text>
                                            </Card.Body>
                                        </Card>
                                    </Col>
                                    <Col md={4} className="d-flex">
                                        <Card className="w-100">
                                            <Card.Body>
                                                <Card.Text>
                                                    Nos recommandations reposent sur des process d’éco-conception et
                                                    d’ACV.
                                                </Card.Text>
                                            </Card.Body>
                                        </Card>
                                    ...
                                    <Col md={4} className="d-flex">
                                        <Card className="w-100">
                                            <Card.Body>
                                                <Card.Text>
                                                    Communication et mise en place d’actions pour le développement
                                                    durable.
                                                </Card.Text>
                                            </Card.Body>
                                        </Card>
